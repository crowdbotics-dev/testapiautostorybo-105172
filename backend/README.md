...
## Project Structure
    ...
    ├── testapiautostorybo_105172  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_105172`
...
2. Clone this repo and `cd testapiautostorybo_105172`
